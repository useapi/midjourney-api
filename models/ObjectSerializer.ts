...
let typeMap: { [index: string]: any } = {
    ...
    "ButtonResponseErrorUpscaled": ButtonResponseErrorUpscaled,
    "DescribeResponse": DescribeResponse,
    "ImagineResponse": ImagineResponse,
    "ImagineResponseModerated": ImagineResponseModerated,
    "JobCancelResponse": JobCancelResponse,
    "JobResponse": JobResponse,
    "JobResponseAttachmentsInner": JobResponseAttachmentsInner,
    "JobResponseChildrenInner": JobResponseChildrenInner,
    "JobResponseEmbedsInner": JobResponseEmbedsInner,
    "JobResponseEmbedsInnerImage": JobResponseEmbedsInnerImage,
    ...
    "ResponseMaxJobs": ResponseMaxJobs,
}
